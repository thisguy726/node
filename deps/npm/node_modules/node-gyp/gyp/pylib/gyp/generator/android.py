  ...
  """
    ...
    """
        ...
        if self.toolset == "host":
            ...
            self.WriteLn(f"LOCAL_SDK_VERSION := {sdk_version}")
    ...
    """
        for action in actions:
            name = make.StringToMakefileVariable(
                f'{self.relative_target}_{action["action_name"]}'
            )
            ...
            self.WriteLn(f"{main_output}: gyp_var_prefix := $(GYP_VAR_PREFIX)")
            self.WriteLn(
            ...
            # set by envsetup.
            self.WriteLn(
                f"{main_output}: export PATH := $(subst $(ANDROID_BUILD_PATHS),,$(PATH))"
            )
